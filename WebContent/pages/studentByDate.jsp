...
<body>
	...
	<div class="mdl-grid" align="center">
			...
			<form method="post">
				<div>
					<span class="mdl-typography--title mdl-color-text--grey-700">
						Enter date to fetch students:
					</span>
				</div>
				<div class="mdl-textfield mdl-js-textfield" style="width:150px">
					<input autofocus class = "mdl-textfield__input" type="text" id="mnth" name="mnth" pattern="[0-1]{1}[0-9]{1}"/>
					<label class = "mdl-textfield__label mdl-color-text--grey-600" for = "mnth">Month</label>
					<span class="mdl-textfield__error">MM</span>
				</div>
				<div class="mdl-textfield mdl-js-textfield" style="width:150px">
					<input autofocus class = "mdl-textfield__input" type="text" id="dy" name="dy" pattern="[0-3]{1}[0-9]{1}"/>
					<label class = "mdl-textfield__label mdl-color-text--grey-600" for = "dy">Day</label>
					<span class="mdl-textfield__error">DD</span>
				</div>
				<div class="mdl-textfield mdl-js-textfield" style="width:150px">
					<input autofocus class = "mdl-textfield__input" type="text" id="yr" name="yr" pattern="[0-9]{4}"/>
		...
		if(request.getParameter("fetchStud") != null){
			...
			date[0] = request.getParameter("mnth");
			date[1] = request.getParameter("dy");
			date[2] = request.getParameter("yr");
			ConnectionManager connMgr = new ConnectionManager();
			ResultSet rs = connMgr.getStudByDate(uid, pwd, date);
			if (rs.isBeforeFirst()) {%>
	<div class="mdl-cell mdl-cell--12-col" style="margin: 1em">
		<br />
