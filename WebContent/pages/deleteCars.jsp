...
<body>
	...
	<div class="mdl-grid" align="center">
		...
		<div class="mdl-cell mdl-cell--12-col" style="margin:1em;">
			<form method="post">
				<div style="width:100%">
					<button type="submit" value="delCars"
							class="mdl-button mdl-color--red-900 mdl-js-button mdl-color-text--grey-100
									mdl-js-ripple-effect mdl-button--raised" name="delCars">
					Delete cars with 4 doors
					</button>
				</div>
			</form>
		</div>
		<%
		if(request.getParameter("delCars") != null){
			ConnectionManager connMgr = new ConnectionManager();
			String result = connMgr.delCars(uid, pwd);%>
		...
		<%}
			ConnectionManager connMgr = new ConnectionManager();
			ResultSet rs = connMgr.getVehicleDetails(uid, pwd, "car");
			if (rs.isBeforeFirst()) {%>
	<div class="mdl-cell mdl-cell--12-col" style="margin: 1em">
		<br />
