...
<body>
	...
	<div class="mdl-grid" align="center">
			...
			<form method="post">
				<div>
					<span class="mdl-typography--title mdl-color-text--grey-700">
						Enter instructor's name to fetch students:
					</span>
				</div>
				<div class="mdl-textfield mdl-js-textfield" style="width:150px">
					<input autofocus class = "mdl-textfield__input" type="text" id="instnm" name="instnm" pattern=".{1,40}"/>
					<label class = "mdl-textfield__label mdl-color-text--grey-600" for = "instnm">Instructor</label>
		...
		if(request.getParameter("fetchStud") != null){
			String instNm = request.getParameter("instnm").toUpperCase();
			ConnectionManager connMgr = new ConnectionManager();
			ResultSet rs = connMgr.getStudByInst(uid, pwd, instNm);
			if (rs.isBeforeFirst()) {%>
	<div class="mdl-cell mdl-cell--12-col" style="margin: 1em">
		<br />
